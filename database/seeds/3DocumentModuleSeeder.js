...
class DocumentModuleSeeder {
  async run() {
    ...
    if (exists) {
      ...
      await ModuleDocument.truncate()
      await ModuleDocument.createMany(JSON.parse(data))
      await Database.raw('SET FOREIGN_KEY_CHECKS = 1;')
    }
  }
}

module.exports = DocumentModuleSeeder
