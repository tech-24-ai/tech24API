...
class QuestionToOptionSeeder {
  async run() {
    ...
    if (exists) {
      ...
      await QuestionOption.truncate()
      await QuestionOption.createMany(JSON.parse(data))
      await Database.raw('SET FOREIGN_KEY_CHECKS = 1;')
    }
  }
}

module.exports = QuestionToOptionSeeder
